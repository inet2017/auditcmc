        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">AuditCMC</span>
            </a>
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="#" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Resumen Ejecutivo</div>
                  </a>
                </li>
                ...
                <li class="menu-item">
                  <a
                    ...
                    target="_blank"
                    class="menu-link">
                    <div class="text-truncate" data-i18n="eCommerce">Análisis</div>
                    <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Nuevo</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Layouts">Activos</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div class="text-truncate" data-i18n="Without menu">Listado por equipos</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div class="text-truncate" data-i18n="Without navbar">Listado por cliente</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Front Pages">Gestión</div>
